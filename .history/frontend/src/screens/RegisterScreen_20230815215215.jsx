    ...
    <FormContainer>
      ...
      <form className="py-2" onSubmit={submitHandler}>
        ...
        <div className="mb-6">
          ...
          <input
            className="peer block min-h-[auto] w-full rounded border-0 bg-transparent px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 peer-focus:text-darkBlue data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none text-neutral-200 placeholder:text-neutral-200 dark:peer-focus:text-darkBlue [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
            id='password'
            type="password"
