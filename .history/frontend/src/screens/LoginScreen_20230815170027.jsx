...
const LoginScreen = () => {
  ...
  return (
    <FormContainer>
      <h1>Sign In</h1>
      <form className="bg-darkBlue mb-4 rounded px-8 pb-8 pt-6 shadow-md" onSubmit={submitHandler}>
        <div className="mb-4">
          <label
        ...
        <div className="mb-6">
          ...
          <input
            className="border-red-500 text-gray-700 focus:shadow-outline mb-3 w-full appearance-none rounded border px-3 py-2 leading-tight shadow focus:outline-none"
            type="password"
