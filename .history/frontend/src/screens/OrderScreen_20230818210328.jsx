      ...
      <div className='grid grid-cols-2'>
        <div className='grid divide-y'>
            <div className='grid grid-rows-5 gap-4'>
                ...
                <p><strong className='bold'>Name:</strong> {order.user.name}</p>
                <p><strong className='bold'>Email:</strong> {order.user.email}</p>
                <p><strong className='bold'>Address:</strong> {order.user.address}</p>
            ...
            <div className='grid grid-rows-3'>
                ...
                <p><strong className='bold'>Method:</strong> </p>
            </div>
            <div></div>
        </div>
        <div></div>
