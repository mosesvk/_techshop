...
const LoginScreen = () => {
  ...
  return (
    <FormContainer>
      <h1 className='text-3xl pb-2 text-darkBlue'>Sign In</h1>
      <form
      ...
      <div>
        ...
        >
          <p className='className="text-blue-500 hover:text-dark inline-block align-baseline text-sm font-bold"'>Register?</p>
        </Link>
      </div>
    </FormContainer>
  );
