    ...
    <FormContainer>
      ...
      <form className="bg-light border mb-4 rounded px-8 pb-8 pt-6 shadow-xl" onSubmit={submitHandler}>
        ...
        <div className="mb-6">
          ...
          <input
            className="border-red-500 text-gray-700 focus:shadow-outline mb-3 w-full appearance-none rounded border px-3 py-2 leading-tight shadow focus:bg-white  bg-light"
            type="password"
