  ...
  return isLoading ? (
    ...
    <div className="xl: lg:w-9/12">
      ...
      <div className="grid grid-cols-3">
        ...
        <div>
          <div className="bg-gray-50 rounded-lg border px-4 py-8 lg:mt-0 divide-y ">
            <h1 className="text-2xl pb-4">Order Summary</h1>
            <div className='mr-8 pt-4'>
                ...
                <div className='flex justify-between bg-warning text-primary-content p-2'>
                    <h1>Total</h1>
